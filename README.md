...
----------------------
    ...
    library:CreateWatermark("youtube:MrMaxNaJa") 
    local CenterHubNo1 = library:CreateWindow("MRMAXNAJA HUB :) ",Enum.KeyCode.RightControl)
    local Tab = CenterHubNo1:CreateTab("TAB MAIN")
    local Sector1 = Tab:CreateSector("Settings","left")
    Sector1:AddLabel(" Main ")
    
    Sector1:AddToggle("Auto Set Spawn Points",true,function(value)
    ...
    if World2 then
        Sector1:AddToggle("Auto Farm Factory",_G.AutoFactory,function(value)
    ...
    elseif World3 then
        ...
        Sector1:AddToggle("Auto Mystic Island",_G.AutoMysticIsland,function(value)
    ...
    Sector1:AddSeperator("Fighting Style")
    
    Sector1:AddToggle("Auto Superhuman",_G.AutoSuperhuman,function(value)
...
-----
    ...
    Sector1:AddToggle("Auto Rengoku",_G.AutoRengoku,function(value)
                        ...
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if (v.Name == "Snow Lurker [Lv. 1375]" or v.Name == "Arctic Warrior [Lv. 1350]") and v.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    topos(v.HumanoidRootPart.CFrame * CFrame.new(15,15,15))
                                    game:GetService'VirtualUser':CaptureController()
                                    game:GetService'VirtualUser':Button1Down(Vector2.new(1380, 850))
...
------------------------------
    ...
    Sector1:AddSeperator("Fruit")





    Sector1:AddToggle("Auto Random Fruit",_G.Random_Auto,function(value)
    ...
    Sector1:AddToggle("Bring Fruit",_G.BringFruit,function(value)
        _G.BringFruit = value
    end)
    ...
    Sector1:AddToggle("Auto Store Fruit",_G.AutoStoreFruit,function(value)
...
Sector1:AddToggle("Auto Drop Fruit",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    Sector1:AddSeperator(" Kill Boss ")
    ...
    local Sector2 = Tab:CreateSector("AUTO FARM","Right")

 
    Sector2:AddSeperator(" AutoFarm ")    
    
    
    Sector2:AddToggle("Bring Mob",true,function(value)
        ...
        Sector2:AddSeperator("World")

        if World1 then
            Sector1:AddToggle("Auto Second Sea",_G.AutoSecondSea,function(value)
        ...
        if World2 then
            Sector2:AddToggle("Auto Third Sea",_G.AutoThirdSea,function(value)
...
Sector2:AddSeperator(" OPEN ")

Sector2:AddButton("ซื้อผล",function()
    local args = {
        [1] = "GetFruits"
    }
...
Sector2:AddButton("ดูอเวกผล",function()
    game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true
    end)

Sector2:AddButton("เปิดกล่องผล",function()
    game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
    end)

Sector2:AddButton("เปิดกล่อง",function()
local args = {
...
Sector2:AddButton("เปิดสีฮาคิ",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Sector2:AddButton("เลือกฉายา",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Sector2:AddToggle("Remove Fog",RemoveFog,function(value)
    RemoveFog = value
...
Sector2:AddButton("FPSBoost", function(t)
...
Sector2:AddButton("FPS Boost 2",function()
    pcall(function()
...
Sector2:AddButton("Click TP Tool",function()
...
local EspPlayers= CenterHubNo1:CreateTab("ESP Players")
local Esp = EspPlayers:CreateSector("ESP MENU","left")

Esp:AddLabel("     Youtube:MrMaxNaJa ")

Esp:AddSeperator(" Hack Esp ")
...
-----------------------
Esp:AddSeperator(" Hack other ")


Esp:AddToggle("Dodge No Cooldown",false,function(value)
    nododgecool = value
    NoDodgeCool()
end)

Esp:AddToggle("Infinite Energy",false,function(value)
    InfiniteEnergy = value
    originalstam = LocalPlayer.Character.Energy.Value
end)

Esp:AddToggle("Infinite Ability",false,function(value)
    InfAbility = value
    if value == false then
        game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
    end
...
Esp:AddToggle("Walk on Water",_G.WalkWater,function(value)
    _G.WalkWater = value
end)
...
Esp:AddToggle("Fly",false,function(value)
    Fly = value
end)
...
Esp:AddToggle("NoClip",_G.NOCLIP,function(value)
    _G.NOCLIP = value
end)
--------------------------


local player = EspPlayers:CreateSector(" KILL Players ","Right")
player:AddSeperator("Closed for renovations")

player:AddSeperator("Mastery Skill Settings")

---false/true



player:AddToggle("Skill Z",false,function(value)
    _G.SkillZ = value
end)

player:AddToggle("Skill X",false,function(value)
    _G.SkillX = value
end)

player:AddToggle("Skill C",false,function(value)
    _G.SkillC = value
end)

player:AddToggle("Skill V",false,function(value)
    _G.SkillV = value
end)

_G.DistanceMob = 2
    player:AddSlider("Distance",1,2,100,2,function(value)
        _G.DistanceMob = value
    end)
    
    player:AddToggle("Auto Skill",_G.AutoSkill,function(value)
        _G.AutoSkill = value 
    end)
...
---------------
    ...
    local Dungeon = CenterHubNo1:CreateTab("DUNGEON + Stats")
    local Dun = Dungeon:CreateSector("Main Menu","left")
    local Tab = Dungeon:CreateSector(" Stats ","Right")
    Dun:AddLabel("   Youtube:MrMaxNaJa ")



--------------------
    Dun:AddSeperator(" DunGeon ")


    

    local TimeRaid = Dun:AddLabel("   Wait For Dungeon")
    ...
    Dun:AddToggle("Auto Farm Dungeon",_G.Auto_Dungeon,function(value)
    ...
    Dun:AddToggle("Auto Awakener",_G.Auto_Awakener,function(value)
    ...
    Dun:AddDropdown("Select Chips",{"None","Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix"},"None",function(value)
        _G.SelectChip = value
    end)
    
    Dun:AddToggle("Auto Select Dungeon",_G.AutoSelectDungeon,function(value)
    ...
    Dun:AddToggle("Auto Buy Chip",_G.AutoBuyChip,function(value)
    ...
    Dun:AddButton("Buy Chip Select",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dun:AddToggle("Auto Start Raid",_G.Auto_StartRaid,function(value)
    ...
    Dun:AddButton("Start Raid",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Dun:AddButton("Next Island",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    ...
    if World2 then
        Dun:AddButton("Teleport to Lab",function()
    ...
    if World2 then
        Dun:AddButton("Awakening Room",function()
    ...
    Tab:AddSeperator("Auto Stats")
    
    local Pointstat = Tab:AddLabel("Stat Points")
    ...
    Tab:AddToggle("Auto Melee",_G.Auto_Melee,function(value)
        _G.Auto_Melee = value
    end)
    
    Tab:AddToggle("Auto Defense",_G.Auto_Defense,function(value)
        _G.Auto_Defense = value
    end)
    
    Tab:AddToggle("Auto Sword",_G.Auto_Sword,function(value)
        _G.Auto_Sword = value
    end)
    
    Tab:AddToggle("Auto Gun",_G.Auto_Gun,function(value)
        _G.Auto_Gun = value
    end)
    
    Tab:AddToggle("Auto Devil Fruits",_G.Auto_DevilFruit,function(value)
        _G.Auto_DevilFruit = value
    end)
    
    _G.PointStats = 1
    Tab:AddSlider("Select Point",1,1,100,1,function(value)
        _G.PointStats = value
    end)
    ...
    Tab:AddSeperator("Status")
    
    local locallv = Tab:AddLabel("Level")
    ...
    local localrace = Tab:AddLabel("Race")
    ...
    local localbeli = Tab:AddLabel("Beli")
    ...
    local localfrag = Tab:AddLabel("Fragment")
 ...
 --------------------------------
    ...
    local localstat = Tab:AddLabel("Stats Points")
    ...
    local localbountyhornor = Tab:AddLabel("Bounty")
    ...
    local localDevil = Tab:AddLabel("Devil Fruit")
    ...
    local Fackmod = CenterHubNo1:CreateTab("Fake + Buy")
    local main = Fackmod:CreateSector("Main Fake","left")
    local Shop = Fackmod:CreateSector(" Shop ","Right")
    main:AddLabel("   Youtube:MrMaxNaJa ")



    main:AddSeperator("Fake All")

    main:AddSeperator("Fake")
    


    main:AddToggle("Enabled Fake",_G.EnabledStat,function(value)
        _G.EnabledStat = value
    end)

    main:AddSlider("Select Point",1,1,2300,1,function(value)
...
-----------------------------------------------------
    ...
    local GGEZ = CenterHubNo1:CreateTab(" Misc ")
    local Mamahaha = GGEZ:CreateSector(" teleport ","left")
    local Misc = GGEZ:CreateSector(" Main ","Right")


    

    Mamahaha:AddSeperator("MaP")
    ...
    if First_Sea then
        Mamahaha:AddButton("Second Sea",function()
    ...
    Mamahaha:AddButton("justical Island",function()
    ...
    Mamahaha:AddButton("Rock Island",function()
    ...
    Mamahaha:AddButton("Carnival Island",function()
    ...
    Mamahaha:AddButton("Chef Ship Island",function()
    ...
    Mamahaha:AddButton("Fishman Island",function()
    ...
    Mamahaha:AddButton("Factory Island",function()
